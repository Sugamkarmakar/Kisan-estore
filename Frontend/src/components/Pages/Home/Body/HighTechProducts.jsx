...
import "./HighTechProducts.css";
import { PiHandbagBold } from "react-icons/pi";
import productsData from "../../../products.json";

const hightechproductssections = [
  {
    title: "HIGH TECH PRODUCTS",
    products: productsData.highTechProducts,
    navigationId: "high-tech-products",
  },
];

const HighTechProducts = () => {
  ...
  return (
    ...
    <Container className="home-container">
      {hightechproductssections.map((section) => (
...
export default HighTechProducts;
